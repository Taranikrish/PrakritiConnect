...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-white w-full py-8 flex justify-center items-center ">
      <div className="container mx-auto flex flex-col items-center justify-center">
        <p className="mb-2">&copy; {new Date().getFullYear()} PrakritiConnect. All rights reserved.</p>
        <div className='flex gap-2'> 
             <a href="mailto:taranikrish7@gmail.com" className="underline">Contact us</a>
        <p >
          <a href="https://github.com/Taranikrish" target="_blank" rel="noopener noreferrer" className="underline flex gap-x-1 items-center justify-center">
                         GitHub:
