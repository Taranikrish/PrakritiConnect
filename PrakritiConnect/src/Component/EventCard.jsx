...
const EventCard = ({ event, onRegister, isRegistered = false }) => {
  return (
    <div className="layout-content-container flex flex-col gap-y-3 max-w-[960px] flex-1">
      <h2 className="text-[#0e1b17] flex justify-center text-3xl font-bold px-4 pt-2">{event.organization}</h2>
      ...
      <div className="flex justify-center px-2 py-2">
        <div
          className="w-7/10 bg-center bg-no-repeat aspect-video bg-cover rounded-lg"
      ...
      <div className="flex px-4 py-3 justify-center">
        <button 
          ...
          className="flex min-w-[84px] cursor-pointer items-center justify-center rounded-lg h-12 px-5 bg-[#14b881] text-[#0e1b17] text-base font-bold hover:bg-[#0fa36d] transition">
...
const DetailRow = ({ label, value }) => (
  <div className="col-span-2 grid grid-cols-subgrid border-t border-t-[#d0e7df] py-5">
