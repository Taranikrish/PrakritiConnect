          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
              ...
              <div className="@[480px]:p-4">
                ...
                >
                  ...
                  <button
                    ...
                    className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-[#14b881] text-[#0e1b17] text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em]"
                  >
            ...
            <div className="flex flex-wrap justify-between gap-3 p-4">
              <div className="flex min-w-72 flex-col gap-3">
                <p className="text-[#0e1b17] tracking-light text-[32px] font-bold leading-tight">Upcoming Events</p>
            ...
            {/* Events List */}
            {events.map((event) => (
              <div key={event.id} className="p-4 @container cursor-pointer" onClick={() => navigate(`/event/${event.id}`)}>
                <div className="flex flex-col items-stretch justify-start rounded-lg @xl:flex-row @xl:items-start shadow-[0_0_4px_rgba(0,0,0,0.1)] bg-[#f8fcfa] hover:shadow-[0_0_8px_rgba(0,0,0,0.2)] transition-shadow">
                  <div
            ...
            <h2 className="text-[#0e1b17] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">How It Works</h2>
